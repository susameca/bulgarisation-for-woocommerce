...
class Nekorekten_Com_Tab extends Base_Tab {
	...
	public function load_fields() {
		$fields = apply_filters( 'woo_bg/admin/settings/nekorektencom/fields', array(
			'nekorekten' => array(
				new Fields\Text_Field( 'api_key', __( 'API Key', 'bulgarisation-for-woocommerce' ), __( 'Enter the generated API key.', 'bulgarisation-for-woocommerce' ), 'required', sprintf( wp_kses_post( __( 'For generating an API key, use this IP address: %s', 'bulgarisation-for-woocommerce' ), sanitize_text_field( $_SERVER['SERVER_ADDR'] ) ) ) . __( 'Note that nekorekten.com may recognize you by another IP address. If so, you\'ll find a message where the reports appear. Copy the IP address from the error and generate a new API key.', 'bulgarisation-for-woocommerce' ) ),
