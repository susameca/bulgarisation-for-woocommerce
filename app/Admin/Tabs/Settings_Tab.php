	...
	public function load_fields() {
		$fields = apply_filters( 'woo_bg/admin/settings/fields', array(
			'nap' => array(
				...
				new Fields\TrueFalse_Field( 'disable_fields', __( 'Disable Checkout fields', 'woo-bg' ), null, null, __( 'This option will hide the plugin fields on the checkout page.', 'woo-bg' ) ),
