...
$calculator_text          = '';
?>
<tr class="woocommerce-shipping-totals shipping woo-bg--shipping-title">
	<th colspan="2"><?php echo wp_kses_post( $package_name ); ?></th>
</tr>

<tr class="woo-bg--shipping-methods">
			...
			<ul id="shipping_method" class="woocommerce-shipping-methods">
				<?php foreach ( $available_methods as $method ) : ?>
					<li>
						...
						printf( '<label for="shipping_method_%1$s_%2$s">%3$s</label>', esc_attr( $index ), esc_attr( sanitize_title( $method->id ) ), wp_kses_post( wc_cart_totals_shipping_method_label( $method ) ) ); // WPCS: XSS ok.
