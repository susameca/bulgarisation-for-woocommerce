...
exports.default = {
	...
	mounted: function mounted() {
		...
		this.paymentBy = wooBg_econt.label.paymentReceiverMethod ? this.paymentByTypes[0] : this.paymentByTypes[1];
	},
...
var render = function () {
  ...
  return _c(
    "div",
    { staticClass: "panel-wrap woocommerce woocommerce--econt" },
    [
      _c(
        "div",
        {
                  ...
                  _vm.paymentBy === "fixed"
                    ? _c("p", { staticClass: "form-field form-field-wide" }, [
                        ...
                        _c("input", {
                          ...
                          attrs: { type: "paymentReceiverAmount" },
                          domProps: { value: _vm.labelData.weight },
                          on: {
                            input: function ($event) {
                              if ($event.target.composing) {
...
//# sourceMappingURL=ad708b2f37329e390e8a.js.map